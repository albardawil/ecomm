...
//    Route::get('orders/rent/tracking', [\App\Http\Controllers\Api\Orders\OrdersController::class, 'orderTrackingRent']);
    ...
    Route::get('packages/{uuid}/payment', [\App\Http\Controllers\Api\Package\PackageController::class, 'payment']);
    Route::post('packages/{uuid}/checkout', [\App\Http\Controllers\Api\Package\PackageController::class, 'checkout']);
    Route::get('packages/{uuid}/payment/details', [\App\Http\Controllers\Api\Package\PackageController::class, 'paymentDetails']);
    ...
    Route::get('orders/{uuid}/pledge', [\App\Http\Controllers\Api\Orders\OrdersController::class, 'pledgeOrder']);
